...
<div id="content">
    ...
    <div class="search-bar">
        <form action="enrollments.php" method="post">
            <input type="text" id="enrollment-search" class="search-field" name="query" placeholder="Search by student or course...">
    ...
    <button class="enroll-student-btn" onclick="openEnrollmentForm('add')"><i class="fas fa-plus"></i> Add New Enrollment</button>
...
<div class="modal" id="addEnrollmentModal">
    <div class="modal-content">
        ...
        <h2 id='modal-title'>Add New Enrollment</h2>
        ...
        <form action="process_enrollment.php" method="post">
            ...
            <button id='add-edit' class="enroll-btn" type="submit" name="add">Add Enrollment</button>
        </form>
    </div>
</div>
...
<div class="modal" id="removeEnrollmentForm">
    <div class="modal-content">
        ...
        <h2 id='modal-remove-title'>Remove Enrollment</h2>
        ...
        <form action="process_enrollment.php" method="post">
            ...
            <button id='remove' class="enroll-btn" type="submit" name="remove">Delete Enrollment</button>
        </form>
    </div>
</div>
<!-- Remove Enrollment Modal -->
...
<div class="modal" id="addMarkModal">
    <div class="modal-content">
        ...
        <form id="markForm" action="process_mark.php" method="post">
          ...
          <button id='add-mark' class="enroll-btn" type="submit" name="addMark">Add Mark</button>
        </form>
...
<script>
    ...
    function openEnrollmentForm(add_OR_edit) {
        if(add_OR_edit == "add"){
            ...
            document.getElementById('modal-title').innerText = "Add Enrollment";
