...
// Calculate gender distribution and average age if there are students
if ($totalStudents > 0) {
...
<div id="content">
    ...
    <div class="search-bar">
        <form action="students.php" method="post">
            <input type="text" id="student-search" class="search-field" name="query" placeholder="Search by student...">
    ...
    <button class="enroll-student-btn" onclick="openEnrollForm('add')"><i class="fas fa-plus"></i> Add New Student</button>
...
<table id="studentTable">
    ...
    <?php foreach ($students as $student): ?>
        <tr>
            ...
            <td> <button class='view-btn' onclick="fetchEnrolledCourses(<?= $student->getId() ?>)">view</button> </td>
            <td>
                <div class="action-buttons">
                    <button class="edit-btn" data-row-index="<?= $i ?>"><i class="fas fa-edit"></i> Edit</button>
                    <button class="delete-btn" data-row-index="<?=$i?>"><i class="fas fa-trash-alt"></i> Delete</button>
                </div>
            </td>
        </tr>
        <?php $i++; ?>
...
<div class="modal" id="enrollForm">
    <div class="modal-content">
        ...
        <form action="process_student.php" method="post" enctype="multipart/form-data">
            ...
            <button id='add-edit' class="enroll-btn" type="submit" name="add">Enroll Student</button>
        </form>
    </div>
</div>
