...
<div id="content">
    ...
    <div class="search-bar">
        <form action="users.php" method="post">
            <input type="text" id="user-search" class="search-field" name="query" placeholder="Search by user...">
    ...
    <button class="enroll-student-btn" onclick="openUserForm('add')"><i class="fas fa-plus"></i> Add New User </button>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <!-- Button to edit user -->
                        <button class="edit-btn" data-row-index="<?= $i ?>" onclick="openUserForm('edit')"><i class="fas fa-edit"></i> Edit</button>
                        <!-- Button to delete user -->
                        <button class="delete-btn" data-row-index="<?= $i ?>" onclick="openRemoveUserForm()"><i class="fas fa-trash-alt"></i> Delete</button>
                    </div>
                </td>
            </tr>
            <?php $i++; ?>
...
<div class="modal" id="addUser">
    <div class="modal-content">
        ...
        <form action="process_user.php" method="post" onsubmit="return validatePassword()">
            ...
            <button id='add-edit' class="enroll-btn" type="submit" name="add">Add User</button>
        </form>
    </div>
</div>
...
<div class="modal" id="removeUserForm">
    <div class="modal-content">
        ...
        <h2 id='modal-remove-title'>Remove User</h2>
        <p>Are you sure you want to remove this user?</p>
        <form action="process_user.php" method="post">
            <input type="hidden" id="removeUserId" name="removeUserId" required>
            <button id='remove' class="enroll-btn" type="submit" name="remove">Delete User</button>
        </form>
    </div>
</div>
